...
file_name: "CLW-BD-001_ClipWatcher全体アーキテクチャ基本設計書.md"
...
related_documents:
  - "CLW-BD-002_ClipWatcher機能基本設計書.md"
  - "CLW-DD-002_コア層起動監視イベント制御詳細設計書.md"
  - "CLW-DD-001_設定画面スキーマ駆動化とグローバルホットキー連携詳細設計書.md"
---
...
| :------------- | :--------------------------------------------------- |
| 文書番号       | CLW-BD-001                                            |
| ファイル名     | CLW-BD-001_ClipWatcher全体アーキテクチャ基本設計書.md |
...
ClipWatcherは、クリップボードの履歴をローカルで管理・再利用するデスクトップアプリケーションです。本書は主要コンポーネント、イベント駆動の連携、および責務境界を定義します。具体的な起動・監視・イベント制御は [CLW-DD-002_コア層起動監視イベント制御詳細設計書.md](CLW-DD-002_コア層起動監視イベント制御詳細設計書.md) を正本とします。
