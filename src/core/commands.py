...
class UpdateHistoryCommand(UndoableCommand):
    ...
    def __init__(self, monitor: ClipboardMonitor, original_text: str, new_text: str):
    ...
    def execute(self):
        ...
        self.monitor.update_history_item(self.original_text, self.new_text)

    def undo(self):
        """Undoes the update, reverting the history item to the original text."""
        self.monitor.update_history_item(self.new_text, self.original_text)
